...
public class MainMenu extends ElementsContainer {
    ...
    private SelenideElement MaimMenuMailPageButton = $("div.main-menu li:nth-child(1)");
    private SelenideElement MaimMenuToolsPageButton = $("div.main-menu li:nth-child(2)");
